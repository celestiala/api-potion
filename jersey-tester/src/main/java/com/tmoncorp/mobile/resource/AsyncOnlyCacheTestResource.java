...
@Path("/memcache/asyncOnly")
public class AsyncOnlyCacheTestResource {
	...
	@GET
	@Cache(type = CacheType.ASYNC_ONLY, expiration = 4)
	@Path("default")
	...
	@GET
	@Cache(type = CacheType.ASYNC_ONLY,expiration = 4,setOnError = false)
	@Path("setOnError")
	...
	@GET
	@Cache(type = CacheType.ASYNC_ONLY,expiration = 4,compress=true)
	@Path("compress")
	...
	@GET
	@Cache(type = CacheType.ASYNC_ONLY,expiration = 4, browserCache = HttpCacheType.NONE)
	@Path("browserCache")
